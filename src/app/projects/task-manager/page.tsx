...
export const metadata = {
  title: "Case Study: Task Manager — Pankaj Maurya",
  description: "Full-stack sprint & workflow management application built with Next.js, Express, and MongoDB.",
};

export default function TaskManagerCaseStudy() {
  const project = projectsData.find((p) => p.slug === "task-manager")!;
