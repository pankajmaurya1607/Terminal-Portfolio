...
import PayFastDiagram from "@/components/diagrams/PayFastDiagram";

export const metadata = {
  title: "Case Study: PayFast — Pankaj Maurya",
  description: "Engineering case study for event-driven payment processor with Go, Apache Kafka, Redis, and PostgreSQL double-entry bookkeeping.",
};

export default function PayFastCaseStudy() {
  const project = projectsData.find((p) => p.slug === "payfast")!;
    ...
    <article className="pt-28 pb-20 max-w-4xl mx-auto px-4 sm:px-6">
      ...
      <section className="mb-12">
        ...
        <p className="text-xs text-slate-400 mb-4">
          High-throughput event-driven microservices architecture in Go, connecting synchronous checkout ingress to Kafka event streams, Redis fraud velocity checks, and PostgreSQL double-entry ledgers.
        </p>
        <PayFastDiagram />
      </section>
