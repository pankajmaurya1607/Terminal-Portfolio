...
import VaultMindDiagram from "@/components/diagrams/VaultMindDiagram";

export const metadata = {
  title: "Case Study: VaultMind — Pankaj Maurya",
  description: "Engineering case study for enterprise RAG knowledge platform with granular RBAC, PostgreSQL 16 PGVector, Celery, and local FastEmbed embeddings.",
};

export default function VaultMindCaseStudy() {
  const project = projectsData.find((p) => p.slug === "vaultmind")!;
  ...
  return (
    <article className="pt-28 pb-20 max-w-4xl mx-auto px-4 sm:px-6">
      ...
      <header className="mb-8 pb-8 border-b border-white/[0.08]">
        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[11px] font-mono bg-purple-500/10 border border-purple-500/20 text-purple-300 mb-4">
        ...
        <p className="text-lg text-purple-400/90 font-mono mb-4">{project.subtitle}</p>
      ...
      <section className="mb-12">
        ...
        <p className="text-xs text-slate-400 mb-4">
          Enterprise RAG workflow linking React 19 SPA with FastAPI, PostgreSQL 16 + PGVector HNSW cosine similarity queries filtered strictly by SQL department IDs, and asynchronous Celery worker pools.
        </p>
        <VaultMindDiagram />
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        ...
        <div className="p-6 rounded-xl bg-purple-950/20 border border-purple-500/20">
          <h2 className="text-xs font-mono font-bold text-purple-400 uppercase tracking-wider mb-2">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6 rounded-xl bg-[#0c0f17] border border-white/[0.08]">
          <h2 className="text-xs font-mono font-bold text-purple-400 uppercase tracking-wider mb-3 flex items-center gap-1.5">
